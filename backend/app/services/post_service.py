...
class PostService:
    ...
    def get_unapproved_posts():
        ...
        posts_list = [{"post_id": post.ID, "username": post.Username, "txt": post.Txt, "image_path": post.ImagePath,
                       "approved": post.Approved} for post in unapproved_posts_list]
        return posts_list
    ...
    def create_post(post_id, username, txt, image_path):
        ...
        post = Post(ID=post_id, Username=username, Txt=txt, ImagePath=image_path)
